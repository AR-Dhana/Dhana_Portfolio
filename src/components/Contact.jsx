...
//                   <p className="text-gray-600">dhanatechdeveloper@gmail.com</p>
//                 </div>
//               </div>
//               <div className="flex items-start space-x-4">
//                 <div className="mt-1 text-blue-600">
...
//                   <p className="text-gray-600">+(91) - 6385229865</p>
//                 </div>
//               </div>
//               <div className="flex items-start space-x-4">
//                 <div className="mt-1 text-blue-600">
...
//                   <p className="text-gray-600">Ekkatudhangal, Chennai</p>
//                 </div>
//               </div>
//             </div>
//           </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <form
              className="space-y-4"
              action="https://formsubmit.co/dhanatechdeveloper@gmail.com"
              method="POST"
            >
