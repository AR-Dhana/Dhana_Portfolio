          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="md:w-1/3">
              ...
              <div className="text-center">
                <h3 className="text-xl font-semibold text-gray-800">Dhanalakshmi</h3>
            ...
            <div className="md:w-4/5">
              ...
              <div className="mt-8">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 text-gray-700">
                  <li><span className="font-medium">Location:</span> Chennai</li>
                  <li><span className="font-medium">Email:</span> dhanatechdeveloper@gmail.com</li>
